...
export class BaseIssueReporterService extends Disposable {
	...
	public setSourceOptions(): void {
		...
		sourceSelect.append(this.makeOption(IssueSource.VSCode, localize('vscode', "OrionIDE"), false)); // [FORK] OrionIDE branding
		sourceSelect.append(this.makeOption(IssueSource.Extension, localize('extension', "An OrionIDE extension"), false)); // [FORK] OrionIDE branding
	...
	public async renderBlocks(): Promise<void> {
		...
		if (selectedExtension && this.nonGitHubIssueUrl) {
			...
			reset(descriptionTitle, localize('handlesIssuesElsewhere', "This extension handles issues outside of OrionIDE")); // [FORK] OrionIDE branding
