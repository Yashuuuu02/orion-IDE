...
export const TAB_INACTIVE_BACKGROUND = registerColor('tab.inactiveBackground', {
	dark: '#2d2d2d', // [FORK] Match --wb-tab-inactive-bg token
	light: '#ECECEC',
	hcDark: null,
	hcLight: null,
...
export const TAB_BORDER = registerColor('tab.border', {
	dark: '#2d2d2d', // [FORK] Match --wb-border token
	light: '#F3F3F3',
...
export const EDITOR_GROUP_HEADER_TABS_BACKGROUND = registerColor('editorGroupHeader.tabsBackground', {
	dark: '#2d2d2d', // [FORK] Match --wb-tab-inactive-bg token for tab header strip
	light: '#F3F3F3',
	hcDark: null,
	hcLight: null
...
export const STATUS_BAR_FOREGROUND = registerColor('statusBar.foreground', {
	dark: '#e5e5e5', // [FORK] Match --wb-text-primary on dark status bar
	light: '#FFFFFF',
	hcDark: '#FFFFFF',
...
export const STATUS_BAR_BACKGROUND = registerColor('statusBar.background', {
	dark: '#0a0a0a', // [FORK] Match --wb-statusbar dark token (was #007ACC blue)
	light: '#007ACC',
	hcDark: null,
	hcLight: null,
...
export const STATUS_BAR_NO_FOLDER_BACKGROUND = registerColor('statusBar.noFolderBackground', {
	dark: '#0a0a0a', // [FORK] Match --wb-statusbar token
	light: '#68217A',
	hcDark: null,
	hcLight: null,
...
export const ACTIVITY_BAR_BACKGROUND = registerColor('activityBar.background', {
	dark: '#252526', // [FORK] Match --wb-sidebar-bg token
	light: '#2C2C2C',
	hcDark: '#000000',
	hcLight: '#FFFFFF'
...
export const ACTIVITY_BAR_INACTIVE_FOREGROUND = registerColor('activityBar.inactiveForeground', {
	dark: Color.fromHex('#6d6d6d'), // [FORK] Match --wb-text-muted token
...
export const ACTIVITY_BAR_ACTIVE_BORDER = registerColor('activityBar.activeBorder', {
	dark: '#007acc', // [FORK] Match --wb-accent token for active indicator
...
export const SIDE_BAR_BACKGROUND = registerColor('sideBar.background', {
	dark: '#252526', // [FORK] Match --wb-sidebar-bg token (preserved)
	light: '#F3F3F3',
	hcDark: '#000000',
	hcLight: '#FFFFFF'
...
export const TITLE_BAR_ACTIVE_BACKGROUND = registerColor('titleBar.activeBackground', {
	dark: '#1f1f1f', // [FORK] Match titleBar.activeBackground design spec
	light: '#DDDDDD',
	hcDark: '#000000',
	hcLight: '#FFFFFF'
...
export const TITLE_BAR_INACTIVE_BACKGROUND = registerColor('titleBar.inactiveBackground', {
	dark: '#1f1f1f', // [FORK] Match titleBar.inactiveBackground design spec (same as active)
...
export const TITLE_BAR_BORDER = registerColor('titleBar.border', {
	dark: '#2d2d2d', // [FORK] Match --wb-border token for title bar bottom border
	light: null,
	hcDark: contrastBorder,
	hcLight: contrastBorder
