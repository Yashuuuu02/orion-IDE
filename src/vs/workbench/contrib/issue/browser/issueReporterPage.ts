...
const acknowledgementsLabel = escape(localize('acknowledgements', "I acknowledge that my OrionIDE version is not updated and this issue may be closed.")); // [FORK] OrionIDE branding
